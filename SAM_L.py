...
for img_name in tqdm(os.listdir("images")):
    ...
    print(f"\nProcessing {img_name} using SAM-LARGE...")
    ...
    plt.suptitle(f"SAM-L Segmentation — {img_name}")
    plt.show()

print("\n Preparing files for download...")
!zip -r output_masks_LARGE.zip output_masks
files.download("output_masks_LARGE.zip")
