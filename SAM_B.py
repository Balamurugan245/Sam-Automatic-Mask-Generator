...
for img_name in tqdm(os.listdir("images")):
    ...
    print(f"Saved mask file: {npy_path} (shape: {binary_masks.shape})")


    overlay, color_mask = show_combined_mask(img, masks[:MAX_MASKS])
    ...
    plt.suptitle(f"SAM Segmentation — {img_name}")
    plt.show()
